    ...
    <div class="card-header">
        ...
        <div class="float-right">
            ...
            <div class="btn-group mr-1 btn-group-sm" role="group">
                <a href="{{ route('attendances.attendance.index') }}" class="btn btn-primary"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="row">
                            <div class="radio col">
                                <label>
                                    {!! Form::radio("status[{$attendee->id}]", 'present', (old('status',
                                    isset($attendee->status) ? $attendee->status : null) == 'present' ? true : true) ,
                                    ['id' => 'status_present', 'class' => '', ]) !!}
                                    Present
                                </label>
                            </div>
                            <div class="radio col">
                                <label>
                                    {!! Form::radio("status[{$attendee->id}]", 'absent', (old('status',
                                    isset($attendee->status) ? $attendee->status : null) == 'absent' ? true : null) ,
                                    ['id' => 'status_absent', 'class' => '', ]) !!}
                                    Absent
                                </label>
                            </div>
                        </div>
