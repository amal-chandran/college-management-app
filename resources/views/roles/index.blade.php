                        ...
                        <td>
                            ...
                            {!! Form::open([
                                ...
                                <div class="btn-group btn-group-xs float-right" role="group">
                                    <a href="{{ route('roles.role.show', $role->id ) }}" class="btn btn-sm btn-info" title="Show Role">
                                        <span class="fas fa-eye" aria-hidden="true"></span> Open
                                    </a>
                                    <a href="{{ route('roles.role.edit', $role->id ) }}" class="btn btn-sm btn-primary" title="Edit Role">
