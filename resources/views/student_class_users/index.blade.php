...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('student_class_users.student_class_user.create') }}"
            class="btn btn-success btn-sm float-right" title="Create New Student Class User">
    ...
    <div class="card-body p-0">
        <table class="table table-condensed">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ isset($studentClassUser->studentClass->batch_name) ? $studentClassUser->studentClass->batch_name : '' }}
                    </td>
                    ...
                    <td>
                        ...
                        <div class="btn-group btn-group-xs float-right" role="group">
                            <a href="{{ route('student_class_users.student_class_user.show', $studentClassUser->id ) }}"
                                class="btn btn-sm btn-info" title="Show Student Class User">
                            ...
                            <a href="{{ route('student_class_users.student_class_user.edit', $studentClassUser->id ) }}"
                                class="btn btn-sm btn-primary" title="Edit Student Class User">
