    ...
    <div class="card">
        <div class="card-header">
          <h4 class="cards-title mb-0 float-left">Permissions</h4>
            <a href="{{ route('permissions.permission.create') }}" class="btn btn-success btn-sm float-right" title="Create New Permission">
                        ...
                        <td>
                            ...
                            {!! Form::open([
                                ...
                                <div class="btn-group btn-group-xs float-right" role="group">
                                    <a href="{{ route('permissions.permission.show', $permission->id ) }}" class="btn btn-sm btn-info" title="Show Permission">
                                        <span class="fas fa-eye" aria-hidden="true"></span> Open
                                    </a>
                                    <a href="{{ route('permissions.permission.edit', $permission->id ) }}" class="btn btn-sm btn-primary" title="Edit Permission">
