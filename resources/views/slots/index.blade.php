                        ...
                        <td>
                            ...
                            {!! Form::open([
                                ...
                                <div class="btn-group btn-group-xs float-right" role="group">
                                    <a href="{{ route('slots.slot.show', $slot->id ) }}" class="btn btn-sm btn-info" title="Show Slot">
                                        <span class="fas fa-eye" aria-hidden="true"></span> Open
                                    </a>
                                    <a href="{{ route('slots.slot.edit', $slot->id ) }}" class="btn btn-sm btn-primary" title="Edit Slot">
