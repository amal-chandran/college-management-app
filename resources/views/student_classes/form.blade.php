<div class="form-group {{ $errors->has('batch') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        {!! Form::text('batch',null, ['class' => 'form-control', 'minlength' => '1', 'placeholder' => 'Enter batch
        here...', ]) !!}
...
<div class="form-group {{ $errors->has('branch') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        {!! Form::text('branch',null, ['class' => 'form-control', 'minlength' => '1', 'placeholder' => 'Enter branch
        here...', ]) !!}
...
<div class="form-group {{ $errors->has('class_teacher_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        {!! Form::select('class_teacher_id',$classTeachers,null, ['class' => 'form-control', 'placeholder' => 'Select
        class teacher', ]) !!}
