    ...
    <div class="card">
        <div class="card-header">
          <h4 class="cards-title mb-0 float-left">Attendees</h4>
            <a href="{{ route('attendees.attendee.create') }}" class="btn btn-success btn-sm float-right" title="Create New Attendee">
                        ...
                        <td>
                            ...
                            {!! Form::open([
                                ...
                                <div class="btn-group btn-group-xs float-right" role="group">
                                    <a href="{{ route('attendees.attendee.show', $attendee->id ) }}" class="btn btn-sm btn-info" title="Show Attendee">
                                        <span class="fas fa-eye" aria-hidden="true"></span> Open
                                    </a>
                                    <a href="{{ route('attendees.attendee.edit', $attendee->id ) }}" class="btn btn-sm btn-primary" title="Edit Attendee">
